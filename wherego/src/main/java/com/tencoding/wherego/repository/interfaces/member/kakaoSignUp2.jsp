...
<body>
  <div class="inner">
    <div class="location"><a href="${pageContext.request.contextPath}/main">홈</a> <span>/</span> <span>회원가입</span></div>
  </div>
  <div>
    <div class="headline">
      <h1>회원 정보 입력(카카오)</h1>
    ...
    <form id="myForm" action="/wherego/member/kakao-sign-up" method="post">
      <div class="form-area">
        <div>
        ...
        <div>
          ...
          <div class="col-box">
            <input type="text" class="input-text" id="mem_id" name="id" value="${id}" readonly />
            <button type="button" class="input-btn" disable>중복확인</button>
          </div>
        ...
        <div>
          ...
          <div class="col-box">
            ...
            <button type="button" class="input-btn" disabled>중복확인</button>
          </div>
        ...
        <div>
          ...
          <div class="col-box">
            <input type="text" class="input-text" id="mem_email" name="email" value="${profile.getKakaoAccount().getEmail()}"/>
          </div>
        ...
        <div>
          ...
          <div class="col-box">
            <input type="text" class="input-text" id="mem_name" name="name" placeholder="성명(한글)" value="${profile.getProperties().getNickname()}"/>
          </div>
        </div>
        ...
        <div class="notice-box">
          <span class="notice-text"> <span class="material-symbols-outlined"> error </span>핸드폰 번호 입력 시 0부터 입력 바랍니다. (예 : 010-****-****) </span>
        </div>
        ...
        <div>
          ...
          <div class="col-box">
            <div class="input-wrap col1">
              <input type="text" class="input-text" name="addr1" id="mem_addr1" placeholder="주소검색 버튼을 클릭하세요" readonly="readonly"/>
            </div>
            <button type="button" class="input-btn" onclick="execDaumPostcode()">주소검색</button>
          </div>
          <div id="wrap" style="display: none; border: 1px solid; width: 690px; height: 400px; margin: 5px 0; position: relative">
            <img
