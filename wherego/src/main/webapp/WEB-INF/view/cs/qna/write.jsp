				...
				<article>
					<form action="#">
						<table class="cs_write_table">
							...
							<tr>
								<td>문의제목</td>
								<td><textarea id="title" name="title" placeholder="제목을 입력하세요." onkeydown="return preventEnterKey(event)" style="height:50px"></textarea></td>
							</tr>
							<tr>
								<td>문의내용</td>
								<td><textarea name="content" placeholder="내용을 입력하세요." style="height:350px"></textarea>
								</td>
							</tr>
						</table>
						<div class="btn_right">
